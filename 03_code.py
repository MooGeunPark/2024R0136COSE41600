...
# PCD 파일이 있는 폴더 경로 설정
folder_path = "/Users/moogeunpark/Desktop/college/code/자율주행/data/03_straight_crawl/pcd"
...
def visualize_multiple_files_with_start_point(pcd_files, folder_path, voxel_size, min_points_in_cluster,
    ...
    min_x_diff = 0.3  # x 차이 최소값
    max_x_diff = 0.8  # x 차이 최대값
    min_y_diff = 0.3  # y 차이 최소값
